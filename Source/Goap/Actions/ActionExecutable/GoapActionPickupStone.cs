...
[GoapAction(GoapActionType.PickupStone)]
public class GoapActionPickupStone : GoapActionBase
{
    ...
    {
        var isStoneInWorld = worldStateModel.GetState(PreconditionsComponent.RequiredEntity + GoapWorldStateConstants.InWorldModifierPostfix) > 0;
